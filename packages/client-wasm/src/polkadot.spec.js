...
const { loadWasmExt, loadWasmRt } = require('../test/helpers');
const wasm = require('./polkadot');

const polkadotCode = loadWasmExt('polkadot_runtime.wasm');
const proxyCode = {
  exports: loadWasmRt('proxy-exports.wasm'),
  imports: loadWasmRt('proxy-imports.wasm')
};
