...
export default function decodeU8a <T> (db: AsyncBaseDb, key: SectionItem<T>): StorageMethod$U8a {
  ...
  return {
    ...
    get: (...keyParams: Array<Storage$Key$Value>): Promise<Uint8Array> =>
      base.get(createKey(keyParams)),
    set: (value: Uint8Array, ...keyParams: Array<Storage$Key$Value>): Promise<void> =>
